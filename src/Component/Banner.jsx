...
function Banner() {
  return (
    ...
    <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 p-6">
      ...
      <div className="bg-slate-900 p-6 rounded-lg shadow-md flex flex-col justify-between h-full">
        ...
        <h1 className='text-2xl md:text-3xl text-white'><span className='text-emerald-400'>Sale Your Laptop</span> </h1>
        ...
        <div className='flex gap-3 mt-4'>
            {/* Buttons start............... */}
          {/* <button className='bg-emerald-500 hover:bg-emerald-600 text-white font-bold py-2 px-4 rounded gap-2 hover:scale-110 transition-transform duration-200 cursor-pointer'>
            Check Details
          </button> */}
    ...
    {/* Card 2 start....................... */}
      <div className="bg-slate-900 p-6 rounded-lg shadow-md flex flex-col justify-between h-full">
        <div className="space-y-4">
        <h1 className='text-2xl md:text-3xl text-white'><span className='text-emerald-400'>Buy New Laptop</span> </h1>
  ...
  or business, we provide the best options at competitive prices. </p>
    ...
    {/* Card 3 start....................... */}
      <div className="bg-slate-900 p-6 rounded-lg shadow-md flex flex-col justify-between h-full">
        <div className="space-y-4">
        <h1 className='text-2xl md:text-3xl text-white'><span className='text-emerald-400'>Refurbished Laptop</span> </h1>
    ...
    {/* Card 4 start....................... */}
      <div className="bg-slate-900 p-6 rounded-lg shadow-md flex flex-col justify-between h-full">
        <div className="space-y-4">
        <h1 className='text-2xl md:text-3xl text-white'><span className='text-emerald-400'>Budget-Friendly IT Solutions</span> </h1>
